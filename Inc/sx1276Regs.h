...
//void lora_set_tx_power(int8_t level, uint8_t output_pin);

//void lora_set_OCP(uint8_t mA);
//void lora_idle(void);
//uint8_t lora_begin_packet(uint8_t implicit_header);
//uint8_t lora_is_transmitting(void);
//uint8_t lora_end_packet(uint8_t async);
